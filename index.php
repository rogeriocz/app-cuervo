...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
    <head>
        ...
        <link href='http://fonts.googleapis.com/css?family=Open+Sans:600italic,400,800,300' rel='stylesheet' type='text/css'>
    ...
    <nav class="navbar navbar-personalizado">
      <div class="container">
        ...
        <a href="#" class="navbar-brand link-personalizado">Google</a>
      </div>
...
<section class="app-principal">
  ...
  <div class="row">
      ...
      <h1 class="app-titulo">Login</h1>
      <p class="app-desc">Entra o registrate con Facebook o Twitter</p>
      <div class="app-redes">
        <div class="app-sociales">
          <div class="app-facebook col-xs-12 col-sm-6 colmd-6 col-lg-6">
          ...
          <div class="app-twitter col-xs-12 col-sm-6 colmd-6 col-lg-6">
...
<div class="container">
      ...
      <div class="col-xs-12 col-md-6 col-md-6 col-lg-6">
        ...
        <ul class="app-lista">
          ...
          <li>Mejora tus comandos</li>
          <li>Guru en Linux</li>
        </ul>

      </div>
      <div class="hidden-xs col-sm-6 col-md-6 col-lg-6 color3">
        <img src="img/app-nuevo.png" class="img-responsive max"alt="">
      </div>
    </div>
  </div>
